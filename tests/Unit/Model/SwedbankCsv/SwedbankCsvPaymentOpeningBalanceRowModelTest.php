...
/**
 * @coversDefaultClass \EMO\PaymentStatementParserBundle\Model\SwedbankCsv\SwedbankCsvPaymentOpeningBalanceRowModel
 */
class SwedbankCsvPaymentOpeningBalanceRowModelTest extends WebTestCase
{
    /**
    ...
    public function testValidate(): void
    {
        ...
        self::assertSame(
            [
                'line-1 Validation for "EMO\PaymentStatementParserBundle\Model\SwedbankCsv\SwedbankCsvPaymentOpeningBalanceRowModel" is not implemented. '.
                'Add it when the need arises. Value: "object of "EMO\PaymentStatementParserBundle\Model\SwedbankCsv\SwedbankCsvPaymentOpeningBalanceRowModel" class".',
            ],
            $violations,
