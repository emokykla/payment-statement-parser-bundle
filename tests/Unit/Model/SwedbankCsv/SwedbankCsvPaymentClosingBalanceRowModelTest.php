...
/**
 * @coversDefaultClass \EMO\PaymentStatementParserBundle\Model\SwedbankCsv\SwedbankCsvPaymentClosingBalanceRowModel
 */
class SwedbankCsvPaymentClosingBalanceRowModelTest extends WebTestCase
{
    /**
    ...
    public function testValidate(): void
    {
        ...
        $swedbankCsvPaymentClosingBalanceRowModel = new SwedbankCsvPaymentClosingBalanceRowModel('line-1', $validRow, '');
        $constraintViolationList = $swedbankCsvPaymentValidatorService->validatePaymentRow($swedbankCsvPaymentClosingBalanceRowModel);
        $violations = ViolationUtils::stringify($constraintViolationList);
        self::assertSame(
            [
                'line-1 Validation for "EMO\PaymentStatementParserBundle\Model\SwedbankCsv\SwedbankCsvPaymentClosingBalanceRowModel" is not implemented. '.
                'Add it when the need arises. Value: "object of "EMO\PaymentStatementParserBundle\Model\SwedbankCsv\SwedbankCsvPaymentClosingBalanceRowModel" class".',
            ],
            $violations,
