...
/**
 * @coversDefaultClass \EMO\PaymentStatementParserBundle\Model\SwedbankCsv\SwedbankCsvPaymentAccruedInterestRowModel
 */
class SwedbankCsvPaymentAccruedInterestRowModelTest extends WebTestCase
{
    /**
    ...
    public function testValidate(): void
    {
        ...
        $validRow = [
            ...
            AbstractSwedbankCsvPaymentRowModel::INPUT_KEY_RECORD_TYPE => $recordType = AbstractSwedbankCsvPaymentRowModel::RECORD_TYPE_ACCRUED_INTEREST,
        ...
        self::assertSame(
            [
                'line-1 Validation for "EMO\PaymentStatementParserBundle\Model\SwedbankCsv\SwedbankCsvPaymentAccruedInterestRowModel" is not implemented. '.
                'Add it when the need arises. Value: "object of "EMO\PaymentStatementParserBundle\Model\SwedbankCsv\SwedbankCsvPaymentAccruedInterestRowModel" class".',
            ],
            $violations,
