...
class SwedbankCsvPaymentTurnoverRowModel extends AbstractSwedbankCsvPaymentRowModel
{
            ...
            new Callback(
                [
                    'callback' => static function (
                        SwedbankCsvPaymentTurnoverRowModel $swedbankCsvPaymentTurnoverRowModel,
