...
class SwedbankCsvPaymentAccruedInterestRowModel extends AbstractSwedbankCsvPaymentRowModel
{
            ...
            new Callback(
                [
                    'callback' => static function (
                        SwedbankCsvPaymentAccruedInterestRowModel $swedbankCsvPaymentAccruedInterestRowModel,
